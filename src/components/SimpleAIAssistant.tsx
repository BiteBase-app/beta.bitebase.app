...
import cloudflareAISimple from "@/utils/cloudflareAISimple";
...
export function SimpleAIAssistant({ className = "" }: SimpleAIAssistantProps) {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const aiResponse = await cloudflareAISimple.callCloudflareAI(aiMessages);
